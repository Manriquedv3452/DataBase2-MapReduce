...
public class InsertMySQL {
    ...
    public static final String PATH_MAPREDUCE1Y2 = "../resultMapReduce1.txt";
    public static final String PATH_MAPREDUCE3 = "../resultMapReduce3.txt";
    public static final String PATH_MAPREDUCE4 = "../resultMapReduce4.txt";
    public static final String PATH_MAPREDUCE5 = "../resultMapReduce5.txt";
    public static final String PATH_MAPREDUCE6 = "../resultMapReduce6.txt";
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
        ...
        try {
            ...
            SQL = "DELETE FROM hourDistribution;";
            statement.executeUpdate(SQL);

            SQL = "DELETE FROM topExtraHashtags;";
            statement.executeUpdate(SQL);

            SQL = "DELETE FROM topHashtags;";
            statement.executeUpdate(SQL);

            SQL = "DELETE FROM topWords;";
            statement.executeUpdate(SQL);

            SQL = "DELETE FROM hashtagsTweets;";
            statement.executeUpdate(SQL);
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                SQL = "INSERT INTO hashtagsTweets VALUES ('" + hashtag + "', " + totalUsers + ", " + totalTweets + ");";
